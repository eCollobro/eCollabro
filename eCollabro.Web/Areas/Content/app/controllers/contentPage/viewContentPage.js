    ...
    $scope.loadContentPage = function () {
        contentPageService.getContentPage($scope.contentPageId).then(function (resp) {
            if (resp.businessException == null) {
                ...
                getContentCommentsController().setCommentFlags($scope.contentPage.IsCommentsAllowed, $scope.contentPage.IsLikeAllowed, $scope.contentPage.IsRatingAllowed, $scope.contentPage.IsVotingAllowed);
